...
import org.openmrs.module.clinicemr.utils.ClinicRegistrationAppUiUtils;
...
public class EditSectionPageController {
	...
	public String post(UiSessionContext sessionContext, PageModel model,
		...
		ClinicRegistrationAppUiUtils.validateLatitudeAndLongitudeIfNecessary(address, errors);
		...
		if (formStructure != null) {
			...
			try {
				...
				ClinicRegistrationAppUiUtils.checkForIdentifierExceptions(ex, errors);
			}
	...
	private void addModelAttributes(PageModel model, Patient patient, Section section, AdministrationService adminService,
		...
		model.put("uiUtils", new ClinicRegistrationAppUiUtils());
