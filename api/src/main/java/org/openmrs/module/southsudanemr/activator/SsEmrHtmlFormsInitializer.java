...
import org.openmrs.module.southsudanemr.utils.SsEmrExtensionFormUtil;
...
public class SsEmrHtmlFormsInitializer implements SsEmrInitializer {
	...
	/**
	 * @see SsEmrInitializer#started()
	 */
	public synchronized void started() {
		log.info("Setting HFE forms for " + SsEmrConstants.MODULE_ID);
		...
		for (String formPath : formPaths) {
			...
			try {
				...
				try {
					...
					ExtensionForm extensionForm = SsEmrExtensionFormUtil.getExtensionFormFromUiResourceAndForm(
