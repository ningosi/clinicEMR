	...
	public static RoleDescriptor SS_USERS = new RoleDescriptor() {
		...
		public List<PrivilegeDescriptor> privileges() {
			return Arrays.asList(Privileges.APP_SSEMRREPORTS_PRV, Privileges.PRV_GET_PATIENTS, Privileges.PRV_GET_CONCEPTS,
			    ...
			    Privileges.PRV_GET_CONCEPT_SOURCES, Privileges.PRV_ADD_VISITS, Privileges.PRV_ACTIVE_VISITS,
			    Privileges.PRV_EDIT_VISITS, Privileges.PRV_LOCATION_ATTRIBUTE_TYPES, Privileges.PRV_VISITS_CONFIGURE,
			    Privileges.PRV_VISITS_DELETE, Privileges.PRV_VISITS_RETROSPECTIVE, Privileges.PRV_VISITS_CORE_APPS_CREATE,
